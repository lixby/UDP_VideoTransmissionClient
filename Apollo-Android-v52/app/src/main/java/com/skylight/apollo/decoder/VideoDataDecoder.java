    ...
    private class VideoPlayerThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                Log.d(TAG, "track count = " + extractor.getTrackCount());
...
//                        Log.v("DecodeActivity", "We can't use this buffer but render it due to the API limit, " + buffer);
                            ...
                            Log.d(TAG, "video pts " + info.presentationTimeUs);
                    ...
                    if (!isEOS) {
                        ...
                        if (inIndex >= 0) {
                            ...
                            if (sampleSize < 0) {
                                ...
                                // flag to decoder, we will get it again from the
                                // dequeueOutputBuffer
                                Log.d(TAG, "InputBuffer BUFFER_FLAG_END_OF_STREAM " + totalSample);
                                decoder.queueInputBuffer(inIndex, 0, 0, 0, MediaCodec.BUFFER_FLAG_END_OF_STREAM);
                                isEOS = true;
                            } else {
//                                totalSample += sampleSize;
                    ...
                    switch (outIndex) {
                        case MediaCodec.INFO_OUTPUT_BUFFERS_CHANGED:
                            ...
                            break;
                        case MediaCodec.INFO_OUTPUT_FORMAT_CHANGED:
                            Log.d("DecodeActivity", "audio format " + decoder.getOutputFormat());
                        ...
                        default:
                            ...
                            Log.d(TAG, "audio pts " + info.presentationTimeUs + " total sample = " + totalSample);
